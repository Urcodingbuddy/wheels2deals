...
export function ChatbotWidget() {
  ...
  return (
    <>
      ...
      {nudge && !open && (
        <div className="fixed bottom-[94px] right-5 z-[97] animate-in slide-in-from-bottom-3 fade-in zoom-in-95 duration-500 ease-out">
          <div className="relative">
            <button
              type="button"
      ...
      <button
        ...
        aria-expanded={open}
        className={`group fixed bottom-6 right-6 z-[97] h-[52px] w-[52px] items-center justify-center rounded-full bg-[#2A3510] shadow-[0_12px_34px_rgba(42,53,16,0.4)] border border-[#C9A84C]/30 transition-transform duration-300 hover:scale-105 active:scale-95 ${open ? "hidden sm:flex" : "flex"}`}
      >
        {!open && (
