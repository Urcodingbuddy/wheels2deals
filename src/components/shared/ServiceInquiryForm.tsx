  ...
  return (
    <div className="flex flex-col gap-1">
      <div className="relative pt-5">
        <label className={`absolute left-0 pointer-events-none font-[family-name:var(--font-body)] transition-all duration-500 ${
          active
        ...
        <input
          ...
          className={`w-full pb-2 bg-transparent font-[family-name:var(--font-body)] text-[14px] text-[#2A3510] focus:outline-none border-b transition-colors duration-200 ${
            error ? "border-red-400" : focused ? "border-[#3A4A20]" : "border-[#D8D4CE]"
          }`}
        />
      </div>
